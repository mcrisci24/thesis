    ...
    if not existing_cols:
        ...
        with st.expander("What does the log-transformation show?"):
            st.markdown("""
                ...
                **Conclusion:**
                Log transformation reveals that income growth has **been evenly distributed** when scaled to across quintiles. This stablization across all qwuintiles suggests that the first plot that show exponential growth can be explained by inflation; which is what causes a higher head of households' labor income to appear to sky rocket after between 2008 - 2012 i.e., the higher a starting heads' labor income, the larger the increase will be as inflation increase with time. Calcuation have were not completed on any relationship between certain years where income for the top quintile appears to increase at a faster rate than previous years, that correspond with years that the US experienced economic downturns like the Great Recession (~2009-2014) as well as the sharper increases after 1991 as the US economy bounced back from the brief recession of 1990 (CITE or you're a DUMBASS MARK). Certainly, there are other confounding variables that played into the economic downturns, but inflation general explains the expontential growth that is commonly found in longitudinal studies of income trajectories over time. Therefore, by log-scaling the data that is plotted above, we adjust for inflation factors, and are able to see all quintiles have similarly--stable--average trajectories between 1968-2022.
                """)
